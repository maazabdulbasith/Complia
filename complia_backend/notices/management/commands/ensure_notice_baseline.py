...
CURATED_NOTICE_SEEDS: list[CuratedNoticeSeed] = [
    ...
    _seed(
        "IT-INTIMATION-HIGH-REFUND-SCRUTINY",
        "High Refund Risk Review Intimation",
        "medium",
        "Income-tax risk-based return processing workflow",
        "income_tax",
    ),
    ...
    _seed(
        "IT-INTIMATION-80TTA-ADJUST",
        "Intimation Adjustment for Section 80TTA",
        "medium",
        "Income-tax Act Section 143(1) read with Section 80TTA",
        "income_tax",
    ),
    _seed(
        "IT-INTIMATION-80TTB-ADJUST",
        "Intimation Adjustment for Section 80TTB",
        "medium",
        "Income-tax Act Section 143(1) read with Section 80TTB",
        "income_tax",
    ),
    _seed(
        "IT-INTIMATION-80CCD1B-ADJUST",
        "Intimation Adjustment for Section 80CCD(1B)",
        "medium",
        "Income-tax Act Section 143(1) read with Section 80CCD(1B)",
        "income_tax",
    ),
    ...
    _seed(
        "IT-INTIMATION-CAPITAL-GAIN-MISMATCH",
        "Capital Gain Mismatch Intimation",
        "high",
        "Income-tax return processing and AIS/TIS comparison",
        "income_tax",
    ),
    _seed(
        "IT-INTIMATION-SCHEDULE-FA",
        "Foreign Asset Disclosure Intimation",
        "high",
        "Schedule FA disclosure requirements under Income-tax return",
        "income_tax",
    ),
    _seed(
        "IT-INTIMATION-SCHEDULE-AL",
        "Assets and Liabilities Schedule Intimation",
        "medium",
        "Schedule AL disclosure requirements under Income-tax return",
        "income_tax",
    ),
    ...
    _seed(
        "IT-INTIMATION-UPDATED-ADDL-TAX",
        "Updated Return Additional Tax Intimation",
        "medium",
        "Income-tax Act Section 140B read with Section 139(8A)",
        "income_tax",
    ),
    ...
    _seed(
        "IT-INTIMATION-PAN-INOP-TDS",
        "Higher TDS due to Inoperative PAN Intimation",
        "medium",
        "Income-tax Act Section 206AA / PAN inoperative rules",
        "income_tax",
    ),
