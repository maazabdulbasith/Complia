...
urlpatterns = [
    ...
    path('api/v1/', include([
        ...
        path('payments/webhooks/razorpay/', RazorpayWebhookView.as_view(), name='payment-webhook-razorpay'),
        ...
        path('auth/', include([
            ...
            path('registration/', EmailRegisterView.as_view(), name='email_register'),
