            ...
            {user ? (
              <>
                {user.user_type === "admin" && (
                  <Link
                    to="/superadmin"
                    className="rounded-xl border border-slate-300/80 bg-white px-2.5 py-2 text-xs font-semibold text-slate-700 transition hover:border-indigo-300 hover:text-indigo-800 sm:hidden"
                  >
                    Admin
                  </Link>
                )}
